angular.module('app', ['ui.router.compat' /* this is for ui-router */, 'ngAnimate',  /* states */ 'features', 'facebook', 'three', 'demo' , 'about', 'ParseServices' /* this is the Parse SDK */, 'ExternalDataServices' /* this is where we define all our models and collections */, 'forms' /* an example directive */, 'FacebookPatch' /* our facebook angular wrapper so we can use FB.apiAngular instead of FB.api */])
